package StripeReader.barcodetypes.datamatrix.decoder;
...
final class BitMatrixParser {
     ...
     */
    protected BitMatrixParser(BitMatrix bitMatrix) throws ReaderException {
     ...
     */
    protected Version readVersion(BitMatrix bitMatrix) throws ReaderException {
     ...
     */
    protected byte[] readCodewords() throws ReaderException {
     ...
     */
    protected boolean readModule(int row, int column, int numRows, int numColumns) {
     ...
     */
    protected int readUtah(int row, int column, int numRows, int numColumns) {
        int currentByte = 0;
     ...
     */
    protected int readCorner1(int numRows, int numColumns) {
        int currentByte = 0;
     ...
     */
    protected int readCorner2(int numRows, int numColumns) {
        int currentByte = 0;
     ...
     */
    protected int readCorner3(int numRows, int numColumns) {
        int currentByte = 0;
        if (readModule(numRows - 1, 0, numRows, numColumns)) {
            currentByte |= 1;
        }
     ...
     */
    protected int readCorner4(int numRows, int numColumns) {
        int currentByte = 0;
        if (readModule(numRows - 3, 0, numRows, numColumns)) {
            currentByte |= 1;
        }
     ...
     */
    protected BitMatrix extractDataRegion(BitMatrix bitMatrix) {
